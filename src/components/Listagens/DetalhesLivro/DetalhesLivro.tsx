...
function DetalhesLivro({ id_livro }: DetalhesLivroProps): JSX.Element {
    ...
    return (
        <main className="bg-gray-200 flex-1 py-6 sm:py-10 px-4 overflow-y-auto">
            <Card title={`${livro.titulo} ${livro.autor}`} className="shadow-lg animate-fade-in transition-all duration-300 w-full max-w-4xl p-4 sm:p-6 md:p-8 mx-auto font-bold text-xl">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-2">
                        ...
                        <div className="flex flex-col gap-4">
                            <h3 className="text-lg font-semibold text-primary-700 flex items-center gap-2">
                                <i className="pi pi-map-marker text-orange-500"></i> Estatísticas do Livro
                            </h3>
                            <div className="flex flex-col gap-3 ml-1 border-l-2 border-orange-50 relative pl-4">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-700 font-medium">
                                        {livro.quant_total ? livro.quant_total : "Não informado"}
                                    </span>
                                </div>
                                <div className="flex flex-col">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-700 font-medium leading-relaxed">{livro.quant_aquisicao}</span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-xs uppercase text-gray-400 font-bold tracking-wider">Valor de Aquisição</span>
                                    <span className="text-gray-700 font-medium leading-relaxed">{livro.valor_aquisicao}</span>
                                </div>
                            </div>
                        </div>
                    </div>
